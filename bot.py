...
class InstaBot:
    ...
    def login(self):
        ...
        time.sleep(4)
        username_input = self.driver.find_element_by_xpath('/html/body/div[1]/section/main/div/article/div/div[1]/div/form/div[2]/div/label/input')
        password_input = self.driver.find_element_by_xpath('/html/body/div[1]/section/main/div/article/div/div[1]/div/form/div[3]/div/label/input')

        username_input.send_keys(self.username)
        password_input.send_keys(self.password)
        login_btn = self.driver.find_element_by_xpath('/html/body/div[1]/section/main/div/article/div/div[1]/div/form/div[4]') # login button xpath changes after text is entered, find first
    ...
    def like_latest_posts(self, user, n_posts, like=True):
        ...
        for img in imgs[:n_posts]:
            ...
            try:
                ...
                print(e)
            time.sleep(4)
            self.driver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/div[3]/section[1]/span[1]/button/svg').click()                
...
if __name__ == '__main__':
    ...
    bot.like_latest_posts('inside.code', 2, like=True)